                ...
                <div class="bg-white rounded-2xl shadow-xl p-6 sm:p-8 lg:p-10 border border-slate-100">
                    ...
                    <div class="space-y-4 text-slate-600">
                        ...
                        <p class="flex items-start gap-3">
                            ...
                            <span><strong>Tanggal Pelaksanaan:</strong><br>{{ isset($settings['event_date']) && strtotime($settings['event_date']) ? \Carbon\Carbon::parse($settings['event_date'])->locale('id')->translatedFormat('d F Y') : ($settings['event_date'] ?? '3 - 10 Juni 2026') }}</span>
                        </p>
                        <p class="flex items-start gap-3">
                ...
                <div class="space-y-5 sm:space-y-6">
                    ...
                    <div class="space-y-3 sm:space-y-4">
                        ...
                        <div class="flex items-start gap-3 sm:gap-4">
                            ...
                            <div>
                                <div class="font-semibold text-base sm:text-lg">{{ isset($settings['event_date']) && strtotime($settings['event_date']) ? \Carbon\Carbon::parse($settings['event_date'])->locale('id')->translatedFormat('d F Y') : ($settings['event_date'] ?? '3 - 10 Juni 2026') }}</div>

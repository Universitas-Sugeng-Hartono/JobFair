...
.status-accepted { background: #ede9fe; color: #4f46e5; }
                ...
                <tr>
                    ...
                    <td style="display:flex;gap:0.4rem;flex-wrap:wrap;align-items:center;">
                        ...
                        <form action="{{ route('applications.status', $application->id) }}" method="POST" style="display:inline;">
                            ...
                            <button type="submit"
                                style="background:#6366f1;color:white;border:none;padding:0.3rem 0.6rem;border-radius:6px;font-size:0.8rem;cursor:pointer;"
